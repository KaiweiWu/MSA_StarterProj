...
import './App.css';
import BananaLogo from './Banana.jpg';
...
class App extends React.Component<{}, IState> {
    ...
    let url = "https://msaphotoapi.azurewebsites.net/api/Classes"
    if (tag !== "") {
        url += "/tag?=" + tag
    }
    fetch(url, {
...
private uploadMeme() {
    ...
    const url = "https://msaphotoapi.azurewebsites.net/api/Classes/upload"
